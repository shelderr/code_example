    ...
    public function rules(Request $request): array
    {
        ...
        return [
            'title'                 => [
                ...
                'min:1',
                'max:255',
                Rule::unique('events', 'title')->where('type', Event::TYPE_SHOW),
            ],
            'title_original_lang'   => [
                'string',
                'min:1',
                'max:255',
                Rule::unique('events', 'title_original_lang')->where('type', Event::TYPE_SHOW),
            ],
            'slogan'                => ['string', 'min:3', 'max:255', Rule::unique('events', 'slogan')],
            'type'                  => ['required', 'string', Rule::in([Event::TYPE_SHOW])],
